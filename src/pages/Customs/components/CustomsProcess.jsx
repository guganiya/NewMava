					...
					{steps.map((step, index) => {
						...
						return (
							<div key={step.id} className='relative mb-32 last:mb-0'>
								<div
									className={`flex flex-col md:flex-row items-center justify-between gap-12 md:gap-32 ${isEven ? 'md:flex-row-reverse' : ''}`}
								>
									{/* Текст с тенями */}
									<motion.div
