		...
		>
			<div className='max-w-5xl mx-auto px-6'>
				...
				<div className='bg-white rounded-[40px] p-10 md:p-12 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-neutral-50 text-center'>
					...
					>
						Get a professional consultation and calculate customs clearance time
						and cost for your cargo.
					</motion.p>

					{/* Кнопки: стали более компактными */}
					<div className='flex flex-wrap justify-center gap-4'>
						{/* Кнопка-ссылка "Get Consultation" */}
						<Link
							to='/contacts'
							className='group relative inline-block bg-[#AD1C42] text-white px-8 py-4 rounded-full font-black uppercase italic tracking-widest text-[11px] transition-all active:scale-95 shadow-[0_10px_20px_rgba(173,28,66,0.2)] text-center no-underline'
						>
						...
						{/* Кнопка-ссылка "View Services" */}
						<Link
							to='/services'
							className='inline-block px-8 py-4 rounded-full border border-neutral-200 text-gray-400 font-black uppercase italic tracking-widest text-[11px] hover:bg-neutral-50 hover:text-[#1a1a1a] transition-all text-center no-underline'
						>
							View Services
						</Link>
					</div>
